  ...
  return (
    <div className="h-screen xl:h-[78vh] ">
      <Carousel slide={false}>
        <section  className="bg-[url('/imgs/cuadross.jpeg')] bg-cover xl:bg-contain h-screen xl:h-[78vh] justify-center flex items-center" id="web">
            <div className=" bg-comp3  h-[70vh] xl:h-[40rem] w-[80vw] align-center ">
              ...
              <div className="flex">
                  ...
                  <img src="/imgs/disweb.jpg" className="rounded-full h-96 w-96 mt-[-2rem] 2xl:ml-44 xl:ml-10 hidden xl:flex" />
              </div>
            </div>
          </section>
        ...
        <section className="bg-[url('/imgs/patron3.jpg')] bg-cover xl:bg-contain h-screen xl:h-[78vh] justify-center flex items-center">
          <div className=" bg-negro  h-[70vh] xl:h-[40rem] w-[80vw] align-center ">
          <h1 class="md:text-8xl  text-5xl max-[400px]:text-4xl max-xl:text-center text-principal 2xl:pt-24 pt-10 xl:pt-10 md:ml-3 ml-2 min-[430px]:ml-4 xl:ml-36">English for communication</h1>
            <div className="flex">
                ...
                <img src="/imgs/ingles.jpg" className="rounded-full h-96 w-96 mt-[1rem] 2xl:mt-[-1rem] 2xl:ml-44 xl:ml-10 hidden xl:flex" />
            </div>
          </div>
        </section>
      </Carousel>
